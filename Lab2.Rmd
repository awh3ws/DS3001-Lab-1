...
df_train$smoked = ifelse(df_train$smoking_status == "formerly smoked" | df_train$smoking_status == "smokes", 1.0, 0)
...
df_train$gluc = ifelse(df_train$avg_glucose_level > 190, 1, 0)
df_train$old = ifelse(df_train$age > 69, 1 , 0)
df_train$overbmi = ifelse(df_train$bmi > 20, 1, 0)
df_train$og = ifelse(df_train$old == 1 & df_train$gluc == 1, 1, 0)
...
model = lm(stroke~.,data=df_train)
test = predict(model, df_test)
