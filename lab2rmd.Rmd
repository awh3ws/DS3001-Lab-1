...
#### k Mean Clustering (kMC) with Linear Regression

When finding that the k Nearest Neighbor alone was not a good fit for the data, we tried using k Means Clustering to cluster the data into groups and then performing linear regression on each of those groups.
...
![](https://lh4.googleusercontent.com/ZC1ixpichXaLM0l36cG9ZHKO75QC1_khdWgFRjv0DHill8YmlmfBl1D8VW46qbymPLNzt4xfVJYVsEgSyYoUXkfToLkL7tHcBN9-c7z9LSUPQOno0Hx2LisT5TNQkug9nOSgQ3ZDpeEw3BQbFTP7ci4)
...
Here is an example of what our data looks like after adding the cluster label:

    ##         age hypertension heart_disease avg_glucose_level stroke cluster
    ## 1 0.4384766            0             0        0.04962607      0       2
    ## 2 0.5483398            0             0        0.06250577      0       1
    ## 3 0.7070312            0             0        0.53462284      0      10
    ## 4 0.7436523            0             0        0.06813775      0       1
    ## 5 0.9511719            0             0        0.22500231      0       3
    ## 6 0.4140625            0             0        0.24628381      0       2

We then evaluated our testing set using our k Means Cluster model to fit them into a cluster and select the correct linear model to predict the stroke value.
...
Here is an example of what our testing data looks like after adding the predicted stroke value and cluster labels:

    ##          age hypertension heart_disease avg_glucose_level stroke cluster
    ## 1 0.70674487            1             0        0.15702559      0       9
    ## 2 0.09579668            0             0        0.26710192      0       8
    ## 3 0.85337243            0             0        0.06619941      0       3
    ## 4 0.57233627            0             0        0.74744371      0      10
    ## 5 0.90224829            1             0        0.72291297      0       9
    ## 6 0.96334311            0             0        0.10479574      0       3
    ##   predicted_stroke
    ## 1                0
    ## 2                0
    ## 3                0
...
Using this we evaluated the `R^2` value of this model:
...
Even with this method, when we tried to predict stroke on our testing set we got an R\^2 of -0.04029. This value didn\'t change significantly when trying different variables within our model, or different cluster, so we can assume that this predicting method isn\'t adequate for this dataset and problem.
